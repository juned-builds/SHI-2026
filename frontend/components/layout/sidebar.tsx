    ...
    <>
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-100">
          <Link
            href="/dashboard"
            className={`flex items-center gap-2.5 text-slate-900 font-bold tracking-tight overflow-hidden ${
        ...
        <div className="hidden md:flex items-center justify-end px-3 py-2 border-t border-slate-100">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-2 rounded-lg text-xs font-medium text-slate-500 hover:text-slate-900 hover:bg-slate-100 transition-colors"
